...
- Follow [PUBLISH.md](../PUBLISH.md) (checksum → push → optional tag). Tag-pinned `v3.0.0` URLs do not move until a new tag

## Not planned

- Fifth installer destination
